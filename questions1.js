// questions1.js - Contract Law Quiz Questions
const questions = [
    {
    ...
    },
    {
        ...
        options: ["Por vezes gratuita", "Um contrato que exige aceitação", "Um ato unilateral do credor", "Automática, quando há perdão"],
        correct: 1,
    ...
    },
    {
        ...
        options: ["Domicílio do devedor", "Domicílio do credor", "Onde a coisa se encontrava no momento da conclusão do negócio", "Tribunal da comarca do domicílio do devedor"],
        correct: 2,
    ...
    },
    {
        ...
        options: ["Serem judicialmente exigíveis", "Não serem judicialmente exigíveis mas existir preclusão da repetição", "Poderem ser executadas", "Necessitarem de garantias"],
        correct: 1,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "O género não perece (*genus nunquam perit*) (art. 540.º), significando que o devedor continua obrigado mesmo que não tenha os bens específicos. No entanto, com a concentração a obrigação deixa de ser genérica e, nesse sentido, o género desaparece."
    },
    {
    ...
    },
    {
        ...
        options: ["O valor da dívida varia com a inflação", "As oscilações do valor da moeda não afetam o montante da dívida", "Só se aceita dinheiro específico", "O pagamento deve ser feito à pessoa cujo nome consta do contrato"],
        correct: 1,
    ...
    {
        question: "A exceção de não cumprimento pressupõe:",
        options: ["Culpa do devedor", "Um contrato sinalagmático", "Autorização judicial", "Prestação de garantias"],
        correct: 1,
        explanation: "A exceção de não cumprimento (arts. 428.º-431.º) pressupõe um contrato (sinalagma), sendo uma exceção material dilatória defensiva."
    },
    {
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Quando há transferência de propriedade, o risco corre por conta do adquirente a contar do momento da aquisição (art. 796.º/1), sem prejuízo de existirem algumas exceções."
    },
    {
    ...
    {
        question: "O devedor responde pelos atos dos auxiliares causadores de danos quando estes:",
    ...
    },
    {
        ...
        options: ["Optar entre indemnização pelo interesse contratual positivo e interesse contratual negativo", "Apenas obter a resolução", "Obter indemnização e exercer o direito de resolução", "Execução específica obrigatória"],
        correct: 2,
        explanation: "No incumprimento definitivo (art. 801.º), o credor pode optar entre indemnização compensatória (pelo interesse contratual positivo - grande indemnização) ou resolução do contrato (com indemnização, calculada pela diferença)."
    },
    {
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Na mora de obrigações pecuniárias há indemnização abstrata através dos juros legais ou convencionais (art. 806.º/1), não podendo o credor alegar danos superiores."
    },
    {
    ...
    },
    {
        ...
        options: ["Apenas bens móveis", "Todo o património do devedor", "Apenas bens registados", "Só bens penhoráveis, excluindo bens comuns do casal"],
        correct: 1,
        explanation: "O património do devedor é garantia geral do cumprimento (arts. 601.º e 817.º), respondendo todo o património por cada dívida - responsabilidade ilimitada."
    },
    {
    ...
    },
    {
        ...
        options: ["Solidária", "Subsidiária com benefício de excussão", "Autónoma", "Limitada no tempo"],
        correct: 1,
