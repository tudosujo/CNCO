...
const questions = [
    ...
    },
    {
        ...
        options: ["Cumpridas na medida do possível", "Pontualmente cumpridas", "Cumpridas de boa fé", "Cumpridas integralmente"],
        correct: 1,
    ...
    },
    {
        ...
        options: ["Sempre gratuita", "Um contrato que exige aceitação", "Um ato unilateral do credor", "Automática quando há perdão"],
        correct: 1,
    ...
    {
        question: "Para a validade do cumprimento, exige-se capacidade do devedor apenas em caso de:",
    ...
    {
        question: "O lugar do cumprimento, supletivamente para coisas móveis, é:",
        options: ["Domicílio do devedor", "Domicílio do credor", "Onde a coisa se encontrava na conclusão do negócio", "Qualquer lugar"],
        correct: 2,
        explanation: "Para coisas móveis, supletivamente, cumpre-se no lugar onde elas se encontravam no momento da conclusão do negócio (art. 773.º)."
    },
    {
    ...
    },
    {
        ...
        options: ["Serem judicialmente exigíveis", "Incoercibilidade e preclusão da repetição", "Poderem ser executadas", "Necessitarem de garantias"],
        correct: 1,
    ...
    {
        question: "Nas obrigações solidárias passivas, qualquer devedor:",
    ...
    {
        question: "Nas obrigações genéricas, o gênero:",
        options: ["Pode perecer", "Nunca perece", "Perece com a concentração", "Depende da vontade das partes"],
        correct: 1,
        explanation: "O gênero não perece (*genus nunquam perit*) (art. 540.º), significando que o devedor continua obrigado mesmo que não tenha os bens específicos."
    },
    {
    ...
    },
    {
        ...
        options: ["O valor varia com a inflação", "As oscilações da moeda não afetam a dívida", "Só se aceita dinheiro específico", "O pagamento deve ser nominal"],
        correct: 1,
    ...
    {
        question: "Na cessão de créditos, o cedente garante:",
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Na mora há simples retardamento (art. 804.º/2) e a prestação ainda é possível, enquanto no incumprimento definitivo não há mais possibilidade de cumprimento."
    },
    {
    ...
    {
        question: "Nos contratos bilaterais com efeitos reais, o risco corre por conta:",
        options: ["Sempre do alienante", "Do adquirente a contar da aquisição", "De quem tem a posse", "Do contratante mais forte"],
        correct: 1,
        explanation: "Quando há transferência de propriedade, o risco corre por conta do adquirente a contar do momento da aquisição (art. 796.º/1)."
    },
    {
        ...
        correct: 1,
        explanation: "A mora do credor pressupõe recusa sem motivo justificado (art. 813.º), não se exigindo culpa mas sendo necessário comportamento impeditivo."
    },
    {
    ...
    {
        question: "A inversão do ônus da prova na responsabilidade contratual (art. 799.º/1) significa que:",
        options: ["O credor prova a culpa", "O devedor deve provar ausência de culpa", "Não há necessidade de prova", "A culpa é irrelevante"],
        correct: 1,
        explanation: "O art. 799.º/1 atribui ao devedor o ônus de demonstrar que o não cumprimento não procede de culpa sua - há inversão do ônus probatório."
    },
    {
        question: "O devedor responde pelos atos dos auxiliares (art. 800.º):",
        options: ["Apenas com culpa sua", "Objetivamente pelos atos relacionados com a execução", "Só por atos dolosos", "Nunca responde"],
        correct: 1,
        explanation: "O art. 800.º estabelece responsabilidade objetiva do devedor pelos atos dos auxiliares, mas apenas condutas relacionadas com a execução da tarefa."
    },
    {
        question: "A declaração antecipada de não cumprimento:",
        options: ["É sempre irrelevante", "Pode constituir justa causa para resolução", "Só vale se for escrita", "Exige forma notarial"],
        correct: 1,
    ...
    {
        question: "No incumprimento definitivo, o credor pode optar entre:",
        options: ["Apenas indemnização", "Apenas resolução", "Indemnização ou resolução", "Execução específica obrigatória"],
        correct: 2,
        explanation: "No incumprimento definitivo (art. 801.º), o credor pode optar entre indemnização compensatória ou resolução do contrato (com indemnização)."
    },
    {
    ...
    {
        question: "Na mora do devedor, a indemnização em obrigações pecuniárias é:",
        options: ["Sempre os danos efetivos", "Os juros legais", "O dobro do valor", "Livre fixação pelo credor"],
        correct: 1,
        explanation: "Na mora de obrigações pecuniárias há indemnização abstrata através dos juros legais (art. 806.º/1), não podendo o credor alegar danos superiores."
    },
    {
    ...
    },
    {
        ...
        options: ["Apenas indemnizatória", "Apenas compulsória", "Indemnizatória ou compulsória", "Apenas punitiva"],
        correct: 2,
        explanation: "A cláusula penal pode ter função indemnizatória (fixação antecipada do dano) ou compulsória (pressionar o devedor), sendo criticada a definição 'comprometida' do art. 810.º."
    },
    {
        question: "A garantia geral das obrigações é:",
        options: ["Apenas bens móveis", "Todo o patrimônio do devedor", "Apenas bens registados", "Só bens penhoráveis"],
        correct: 1,
